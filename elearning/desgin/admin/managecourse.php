...
if (!isset($_SESSION['uname'])) {
 ...
 # code...
    ...
    // include "manage_course_class.php";
...
<body>
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="http://localhost/elearning/desgin/admin/edit_course_details.php">
                            ...
                            <span class="text nav-text">Edit Course</span>
                        </a>
                    </li>
    ...
    <script src="script.js"></script>
     <section class="home">
        <div class="text">Adding course</div>
...
<div class="card mt-3 tab-card" style="padding-top:0%;" >
    
    <div class="card-header tab-card-header"style="position:fixed;padding-left:30%;">
    ...
    <div class="tab-content" id="myTabContent" >   <!-- tab content starts -->
      ...
      <div class="tab-pane fade show active p-3" style="padding:3%;"id="one" role="tabpanel" aria-labelledby="one-tab" >
        ...
        <div class="card-body col-md-12">
                ...
                <div class="card" style="color:var(--text-color);box-shadow: 2px 2px 2px 2px  #00E77F;margin:10%;padding:10%;background-color:var(--sidebar-color);">
              <div class="card-header bg-danger text-light p-2 cardh2"style="padding-bottom:4%;"><h3>ADD NEW COURSE</h3></div>
              ...
              <form action="course_add.php" method="post" style="font-weight:bold;" enctype="multipart/form-data" onsubmit="return validation()" >
                    <div class="form-group" style="padding:2%;">
                      <label for="email" style="padding-right:5%;">Course Name :</label>
                    ...
                    <div class="form-group"style="padding:2%;">
                      <label for="pwd"style="padding-right:5%;">Course Description</label>
      ...
      <div class="tab-pane fade p-3" style="padding:5%;" id="two" role="tabpanel" aria-labelledby="two-tab">
        ...
        <div class="card-body col-md-12">
              ...
              <div class="card-header bg-primary text-light p-2 cardh2 "style="color:var(--text-color);"><h3>UPDATE COURSE</h3></div>
              
              <!-- <div class="card-body small" > -->
                    
             

             <form action="course_add.php" method="post" enctype="multipart/form-data" onsubmit="" style="color:var(--text-color);font-weight:bold;">


                  <div class="form-group"style="padding:2%;">

                    <label for="exampleFormControlSelect1"style="padding-right:5%;">Select Course Name :</label>
                    <select style="padding-left:5%;"class="form-control" id="exampleFormControlSelect1" name="selected-course-to-update">

                        <?php 
                        include"conn.php";
                        $conn = mysqli_connect('localhost','root','','elearning_courses');
                        $qry = "select * from courses";
                        // $qry = "select * from elearning_courses";
      ...
      <div class="tab-pane fade p-3" style="padding:5%;" id="three" role="tabpanel" aria-labelledby="three-tab">
        ...
        <div class="card-body col-md-12">
              ...
              <div class="card-header bg-primary text-light p-2 cardh2"style="padding:2%;"><h3>DELETE COURSE</h3></div>
...
if (isset($_POST['btn_update'])) {
	$course_name=$_POST['selected-course-to-update'];
$languageimg=$_FILES['course_image'];
$languagedesc=$_POST['course_desc'];
...
if (in_array($filecheck,$fileextstored)) {
	...
	$q=" UPDATE courses SET description='$languagedesc' WHERE course_name='$course_name''";
	$r=mysqli_query($con,$q);

 if ($r==true) {
  echo "<script>alert('udpated');</script>";
    }
